...
},{"@firebase/app":"../node_modules/@firebase/app/dist/index.esm.js"}],"../firebase/firebaseConfiguration.js":[function(require,module,exports) {
"use strict";
...
},{"firebase/app":"../node_modules/firebase/app/dist/index.esm.js"}],"../node_modules/@firebase/auth/dist/auth.esm.js":[function(require,module,exports) {
var global = arguments[3];
"use strict";
  ...
  */
  ...
  function kn(a, b, c, d, e) {
    ...
    var f = og(c.providerId),
        g = Qe(a.uid + ":::"),
        h = null;
    (!Te() || Ie()) && a.s && c.isOAuthProvider && (h = fk(a.s, a.l, a.m, b, c, null, g, _app.default.SDK_VERSION || null, null, null, a.tenantId));
  ...
  (function () {
    if ("undefined" !== typeof _app.default && _app.default.INTERNAL && _app.default.INTERNAL.registerComponent) {
      ...
      _app.default.registerVersion("@firebase/auth", "0.15.3");
...
},{"@firebase/app":"../node_modules/@firebase/app/dist/index.esm.js"}],"../node_modules/firebase/auth/dist/index.esm.js":[function(require,module,exports) {
"use strict";

require("@firebase/auth");
},{"@firebase/auth":"../node_modules/@firebase/auth/dist/auth.esm.js"}],"scripts/utilities.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initializeSigninButtons = exports.assignClick = void 0;
...
var assignClick = function assignClick(elementId, func) {
  var clickElement = document.getElementById(elementId);
  if (clickElement) clickElement.onclick = func;
};

exports.assignClick = assignClick;

var initializeSigninButtons = function initializeSigninButtons() {
  var signInButton = document.getElementById('appbar-signin-button');
  var signOutButton = document.getElementById('appbar-signout-button');
  var addTuneButton = document.getElementById('appbar-addtune-button');
  var mySongsLink = document.getElementById('appbar-mysongs-link');
...
exports.initializeSigninButtons = initializeSigninButtons;
},{"firebase/app":"../node_modules/firebase/app/dist/index.esm.js","firebase/auth":"../node_modules/firebase/auth/dist/index.esm.js"}],"../firebase/firebaseAuthentication.js":[function(require,module,exports) {
"use strict";
...
var googleSignin = function googleSignin() {
  ...
  _app.default.auth().signInWithPopup(provider).then(function (result) {
    return console.log('succesfully logged', result.user.displayName);
  }).catch(function (error) {
    return console.log('error on sign in with google', error);
  });
};
...
var signOut = function signOut() {
  _app.default.auth().signOut().then(function () {
    return console.log('succesfully logged out');
  }).catch(function (error) {
    return console.log('error on sign out with google', error);
  });
};
...
require("../../firebase/firebaseConfiguration");
...
},{"../../firebase/firebaseConfiguration":"../firebase/firebaseConfiguration.js","./utilities":"scripts/utilities.js","../../firebase/firebaseAuthentication":"../firebase/firebaseAuthentication.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
